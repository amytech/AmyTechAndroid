package com.amytech.android.framework.view.widget.progressbar;
...
public class ArcProgress extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            canvas.drawText(suffixText, getWidth() / 2.0f + textPaint.measureText(text) + suffixTextPadding, textBaseline + textHeight - suffixHeight,
                    textPaint);
        }
